...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '桂ICP备17006323号',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  '1240876905@qq.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '爵特猛博客',             //网站名：
    'WEB_KEYWORDS'              =>  '爵特猛,帅白,技术博客,个人博客,lzm',         //网站关键字
    'WEB_DESCRIPTION'           =>  '爵特猛的个人技术博客,lzm官方网站',      //网站描述
    'AUTHOR'                    =>  '爵特猛',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为爵特猛原创文章,转载无需和我联系,但请注明来自爵特猛博客www.lizhengmeng.club',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '爵特猛博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'www.lizhengmeng.club',      //文字水印内容
    'TEXT_WATER_TTF_PTH'        =>  './Public/static/font/ariali.ttf',   //文字水印字体路径
    'TEXT_WATER_FONT_SIZE'      =>  '18', //文字水印文字字号
    'TEXT_WATER_COLOR'          =>  '#5ea8fb',     //文字水印文字颜色
    ...
    'IMAGE_WATER_ALPHA'         =>  '50',    //图片水印 水印透明度：0-100

//*************************************第三方登录****************************************
    'QQ_APP_ID'                 =>  '101469613',            // QQ登录APP D
    'QQ_APP_KEY'                =>  'd5701e86b7c071fcd285907113a3b36b',           // QQ登录APP KEY
    'SINA_API_KEY'              =>  '2214965598',         // 新浪登录API KEY
    'SINA_SECRET'               =>  '0db7c19eace92d66787ea248c62e6725',          // 新浪登录SECRET
...
//***********************************其他第三方接口****************************************
    ...
    'BAIDU_SITE_URL'            =>  'http://data.zz.baidu.com/urls?site=www.lizhengmeng.club&token=C5mkqCDAkColc1am',       // 百度推送site提交接
//***********************************邮箱设置***********************************************
    'EMAIL_SMTP'                =>  '',           //  SMTP服务器
