...
<head>
<meta charset="UTF-8">
<title>网站信息</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    ...
    <link rel="stylesheet" type="text/css" href="/blog/Template/default/Home/Public/css/index.css">    <link rel="stylesheet" href="/blog/Public/static/iCheck-1.0.2/skins/all.css">
</head>
<body>
<form action="<?php echo U('Admin/Config/index');?>" method="post">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#basic" data-toggle="tab">网站设置</a></li>
        <li><a href="#seo" data-toggle="tab">优化推广</a></li>
        <li><a href="#water" data-toggle="tab">文章水印</a></li>
        <li><a href="#oauth" data-toggle="tab">第三方登录</a></li>
        <li><a href="#other" data-toggle="tab">其他第三方接口</a></li>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="basic">
            ...
            <tr>
                ...
                <td>
                    <span class="inputword">开启</span><input class="icheck" type="radio" name="WEB_STATUS" value="1" <?php if(($data['WEB_STATUS']) == "1"): ?>checked="checked"<?php endif; ?> > <span class="inputword">关闭</span><input class="icheck" type="radio" name="WEB_STATUS" value="0" <?php if(($data['WEB_STATUS']) == "0"): ?>checked="checked"<?php endif; ?> >
                </td>
            </tr>
            <tr>
                <th>
        ...
        <div class="tab-pane fade" id="water">
            ...
            <tr>
                ...
                <td>
                    <span class="inputword">文字水印</span><input class="icheck" type="radio" name="WATER_TYPE" value="1" <?php if(($data['WATER_TYPE']) == "1"): ?>checked="checked"<?php endif; ?> > <span class="inputword">图片水印</span><input class="icheck" type="radio" name="WATER_TYPE" value="2" <?php if(($data['WATER_TYPE']) == "2"): ?>checked="checked"<?php endif; ?> > <span class="inputword">关闭水印</span><input class="icheck" type="radio" name="WATER_TYPE" value="0" <?php if(($data['WATER_TYPE']) == "0"): ?>checked="checked"<?php endif; ?> >
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <span class="inputword">上左</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="1" <?php if(($data['IMAGE_WATER_LOCATE']) == "1"): ?>checked="checked"<?php endif; ?> > <span class="inputword">上中</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="2" <?php if(($data['IMAGE_WATER_LOCATE']) == "2"): ?>checked="checked"<?php endif; ?> > <span class="inputword">上右</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="3" <?php if(($data['IMAGE_WATER_LOCATE']) == "3"): ?>checked="checked"<?php endif; ?> ><br>
                    <span class="inputword">中左</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="4" <?php if(($data['IMAGE_WATER_LOCATE']) == "4"): ?>checked="checked"<?php endif; ?> > <span class="inputword">中中</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="5" <?php if(($data['IMAGE_WATER_LOCATE']) == "5"): ?>checked="checked"<?php endif; ?> > <span class="inputword">中右</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="6" <?php if(($data['IMAGE_WATER_LOCATE']) == "6"): ?>checked="checked"<?php endif; ?> ><br>
                    <span class="inputword">下左</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="7" <?php if(($data['IMAGE_WATER_LOCATE']) == "7"): ?>checked="checked"<?php endif; ?> > <span class="inputword">下中</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="8" <?php if(($data['IMAGE_WATER_LOCATE']) == "8"): ?>checked="checked"<?php endif; ?> > <span class="inputword">下右</span><input class="icheck" type="radio" name="IMAGE_WATER_LOCATE" value="9" <?php if(($data['IMAGE_WATER_LOCATE']) == "9"): ?>checked="checked"<?php endif; ?> >
                </td>
            </tr>
            <tr>
                <th>
        ...
        <div class="tab-pane fade" id="comment">
            ...
            <tr>
                ...
                <td>
                    <span class="inputword">开启</span><input class="icheck" type="radio" name="COMMENT_REVIEW" value="1" <?php if(($data['COMMENT_REVIEW']) == "1"): ?>checked="checked"<?php endif; ?> > <span class="inputword">关闭</span><input class="icheck" type="radio" name="COMMENT_REVIEW" value="0" <?php if(($data['COMMENT_REVIEW']) == "0"): ?>checked="checked"<?php endif; ?> >
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <span class="inputword">开启</span><input class="icheck" type="radio" name="COMMENT_SEND_EMAIL" value="1" <?php if(($data['COMMENT_SEND_EMAIL']) == "1"): ?>checked="checked"<?php endif; ?> > <span class="inputword">关闭</span><input class="icheck" type="radio" name="COMMENT_SEND_EMAIL" value="0" <?php if(($data['COMMENT_SEND_EMAIL']) == "0"): ?>checked="checked"<?php endif; ?> >
                </td>
            </tr>
            <tr>
                <th>
