...
<head>
<meta charset="UTF-8">
<title>添加文章</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
...
<form class="form-group" action="<?php echo U('Admin/Article/add');?>" method="post">
    ...
    <tr>
        ...
        <td>
            <?php if(is_array($allTag)): foreach($allTag as $key=>$v): ?><span class="inputword"><?php echo ($v['tname']); ?></span><input class="icheck" type="checkbox" name="tids[]" value="<?php echo ($v['tid']); ?>"> &emsp;<?php endforeach; endif; ?>
        </td>
    </tr>
    <tr>
        <th>
...
<script src="/blog/Public/static/ueditor1_4_3/ueditor.config.js"></script>
<script src="/blog/Public/static/ueditor1_4_3/ueditor.all.js"></script>
<script>
    ...
    <tr>
        ...
        <td>
            <span class="inputword">是</span><input class="icheck" type="radio" name="is_original" value="1" checked="checked"> &emsp; <span class="inputword">否</span><input class="icheck" type="radio" name="is_original" value="0">
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <span class="inputword">是</span><input class="icheck" type="radio" name="is_top" value="1"> &emsp; <span class="inputword">否</span><input class="icheck" type="radio" name="is_top" value="0" checked="checked">
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <span class="inputword">是</span><input class="icheck" type="radio" name="is_show" value="1" checked="checked"> &emsp; <span class="inputword">否</span><input class="icheck" type="radio" name="is_show" value="0">
        </td>
    </tr>
    <tr>
        <th>
...
<!-- 百度统计结束 -->
<script src="/blog/Public/static/iCheck-1.0.2/icheck.min.js"></script>
<script>
