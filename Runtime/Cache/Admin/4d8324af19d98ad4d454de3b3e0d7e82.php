...
<head>
<meta charset="UTF-8">
<title>全部管理员</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
...
<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
    ...
    <td>
        <a href="<?php echo U('Admin/User/is_admin',array('id'=>$v['id'],'is_admin'=>$v['is_admin']));?>"><?php if(($v['is_admin']) == "1"): ?>取消标记<?php else: ?>标记为站长<?php endif; ?></a>
    </td>
