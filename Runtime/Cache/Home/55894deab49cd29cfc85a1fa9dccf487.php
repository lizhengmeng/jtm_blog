...
<head>
<meta charset="UTF-8">
<title>小玩意儿-<?php echo (C("WEB_NAME")); ?></title>
        ...
        <div class="col-xs-12 col-md-12 col-lg-8">
            ...
            <div class="row b-one-article">
                <h3 class="col-xs-12 col-md-12 col-lg-12">
                    <a class="b-oa-title" href="<?php echo U('Baidu/detection');?>" onclick="return recordId('<?php echo ($v['extend']['type']); ?>',<?php echo ($v['extend']['id']); ?>)">人像检测</a>
                </h3>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                            <figure class="b-oa-pic b-style1">
                                <a href="<?php echo U('Baidu/detection');?>">
                                    <img src="/blog/Upload/image/face.jpg" alt="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>" title="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>">
                                </a>
                                <figcaption><a href="<?php echo U('Baidu/detection');?>"></a></figcaption>
                            </figure>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 b-des-read">
                            人像检测应用：用户可以上传一张带有人像的照片，该应用可以扫描用户上传的照片并作简单分析，然后进行评分。
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row b-one-article">
                <h3 class="col-xs-12 col-md-12 col-lg-12">
                    <a class="b-oa-title" href="<?php echo U('Baidu/matching');?>" onclick="return recordId('<?php echo ($v['extend']['type']); ?>',<?php echo ($v['extend']['id']); ?>)">人像对比</a>
                </h3>
                <div class="col-xs-12 col-md-12 col-lg-12 b-date">
                </div>
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                            <figure class="b-oa-pic b-style1">
                                <a href="<?php echo U('Baidu/matching');?>">
                                    <img src="/blog/Upload/image/face.jpg" alt="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>" title="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>">
                                </a>
                                <figcaption><a href="<?php echo U('Baidu/matching');?>"></a></figcaption>
                            </figure>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 b-des-read">
                            人像对比应用：用户可以上传两张带有人像的照片，后台进行扫描对比用户上传的照片并作简单分析，然后进行评分。
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row b-one-article">
                <h3 class="col-xs-12 col-md-12 col-lg-12">
                    <a class="b-oa-title" href="<?php echo U('Games/gobang');?>" onclick="return recordId('<?php echo ($v['extend']['type']); ?>',<?php echo ($v['extend']['id']); ?>)">五子棋</a>
                </h3>
                <div class="col-xs-12 col-md-12 col-lg-12 b-date">
                </div>
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                            <figure class="b-oa-pic b-style1">
                                <a href="<?php echo U('Games/gobang');?>">
                                    <img src="/blog/Upload/image/face.jpg" alt="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>" title="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>">
                                </a>
                                <figcaption><a href="<?php echo U('Games/gobang');?>"></a></figcaption>
                            </figure>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 b-des-read">
                            五子棋。
