...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/blog/Template/default_src/Home/Public/css/index.css">
    <link rel="stylesheet" type="text/css" href="/blog/Public/static/css/animate.css">
<!-- head头部分结束 -->
    <link rel="canonical" href="<?php echo U('Home/Index/category',array('cid'=>$_GET['cid']),'',true);?>" />
</head>
<!-- head头部分结束 -->
<body>
<!-- 顶部导航开始 -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav b-nav-parent">
                ...
                <?php if(is_array($categorys)): foreach($categorys as $key=>$v): ?><li class="b-nav-cname <?php if(($cid) == $v['cid']): ?>b-nav-active<?php endif; ?> ">
                        <a href="<?php echo U('Home/Index/category',array('cid'=>$v['cid']));?>" onclick="return recordId('cid',<?php echo ($v['cid']); ?>)"><?php echo ($v['cname']); ?></a>
                    </li><?php endforeach; endif; ?>
                <li class="b-nav-cname <?php if(($cid) == "chat"): ?>b-nav-active<?php endif; ?> ">
                    <a href="<?php echo U('Home/Index/chat');?>">随言碎语</a>
                </li>
                <li class="b-nav-cname hidden-sm  <?php if(($cid) == "git"): ?>b-nav-active<?php endif; ?> ">
                    <a href="<?php echo U('Home/Index/git');?>">开源项目</a>
                </li>
            </ul>
...
<div class="col-xs-12 col-md-12 col-lg-8">
    ...
    <?php if(is_array($articles)): foreach($articles as $key=>$v): ?><div class="row b-one-article">
            <h3 class="col-xs-12 col-md-12 col-lg-12">
                <a class="b-oa-title" href="<?php echo ($v['url']); ?>" target="_blank" onclick="return recordId('<?php echo ($v['extend']['type']); ?>',<?php echo ($v['extend']['id']); ?>)"><?php echo ($v['title']); ?></a>
            </h3>
    ...
    <div class="b-tags">
        ...
        <ul class="b-all-tname">
            ...
            <?php if(is_array($tags)): foreach($tags as $k=>$v): $tag_i++; ?>
                ...
                <li class="b-tname">
                    <a class="tstyle-<?php echo ($tag_i); ?>" href="<?php echo U('Home/Index/tag',array('tid'=>$v['tid']));?>" onclick="return recordId('tid',<?php echo ($v['tid']); ?>)"><?php echo ($v['tname']); ?> (<?php echo ($v['count']); ?>)</a>
                </li><?php endforeach; endif; ?>
        </ul>
    </div>
    ...
    <div class="b-link">
        ...
        <div>
            <?php if(is_array($new_comment)): foreach($new_comment as $key=>$v): ?><ul class="b-new-comment <?php if(($key) == "0"): ?>b-new-commit-first<?php endif; ?>">
                    <img class="b-head-img js-head-img" src="/blog/Template/default_src/Home/Public/image/qq_default.jpg" _src="<?php echo ($v['head_img']); ?>" alt="<?php echo ($v['nickname']); ?>">
                    <li class="b-nickname">
                        <?php echo ($v['nickname']); ?><span><?php echo ($v['date']); ?></span>
                    </li>
                    <li class="b-nc-article">
                        在<a href="<?php echo U('Home/Index/article',array('aid'=>$v['aid']));?>" target="_blank"><?php echo ($v['title']); ?></a>中评论
                    </li>
                    <li class="b-content">
                        <?php echo ($v['content']); ?>
                    </li>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12 b-login-row">
                <ul class="row">
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
                        <a href="<?php echo U('Home/User/oauth_login',array('type'=>'qq'));?>"><img src="/blog/Template/default_src/Home/Public/image/qq-login.png" alt="QQ登录" title="QQ登录"></a>
                    </li>
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
                        <a href="<?php echo U('Home/User/oauth_login',array('type'=>'sina'));?>"><img src="/blog/Template/default_src/Home/Public/image/sina-login.png" alt="微博登录" title="微博登录"></a>
                    </li>
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
                        <a href="<?php echo U('Home/User/oauth_login',array('type'=>'douban'));?>"><img src="/blog/Template/default_src/Home/Public/image/douban-login.png" alt="豆瓣登录" title="豆瓣登录"></a>
                    </li>
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
                        <a href="<?php echo U('Home/User/oauth_login',array('type'=>'renren'));?>"><img src="/blog/Template/default_src/Home/Public/image/renren-login.png" alt="人人登录" title="人人登录"></a>
                    </li>
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
                        <a href="<?php echo U('Home/User/oauth_login',array('type'=>'kaixin'));?>"><img src="/blog/Template/default_src/Home/Public/image/kaixin-login.png" alt="开心网登录" title="开心网登录"></a>
                    </li>
                    <li class="col-xs-6 col-md-4 col-lg-4 b-login-img">
...
<script src="/blog/Template/default_src/Home/Public/js/index.js"></script>
<!-- 百度页面自动提交开始 -->
<script>
(function(){
