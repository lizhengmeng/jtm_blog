...
<link rel="stylesheet" type="text/css" href="/blog/Public/static/ueditor1_4_3/third-party/SyntaxHighlighter/shCoreDefault.css" />
...
<div id="b-content" class="container">
            ...
            <div class="row b-article">
                ...
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <ul class="row b-metadata">
                        ...
                        <li class="col-xs-5 col-md-2 col-lg-2"><i class="fa fa-list-alt"></i><a href="<?php echo U('Home/Index/category',array('cid'=>$article['current']['category']['cid']));?>"><?php echo ($article['current']['category']['cname']); ?></a><?php if(!empty($article['current']['tag'])): ?><li class="col-xs-7 col-md-5 col-lg-4 "><i class="fa fa-tags"></i><?php if(is_array($article['current']['tag'])): foreach($article['current']['tag'] as $key=>$v): ?><a class="b-tag-name" href="<?php echo U('Home/Index/tag',array('tid'=>$v['tid']));?>"><?php echo ($v['tname']); ?></a><?php endforeach; endif; ?></li><?php endif; ?>
                    </ul>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-12 b-content-word">
                     <?php echo ($article['current']['content']); if(($article['current']['is_original']) == "1"): ?><p class="b-h-20">
                    </p>
                    <p class="b-copyright">
                         <?php echo (C("COPYRIGHT_WORD")); ?>
                    </p><?php endif; ?>
                    <ul class="b-prev-next">
                        <li class="b-prev"> 上一篇：<?php if(empty($article['prev'])): ?><span>没有了</span><?php else: ?><a href="<?php echo ($article['prev']['url']); ?>"><?php echo ($article['prev']['title']); ?></a><?php endif; ?></li>
                        <li class="b-next"> 下一篇：<?php if(empty($article['next'])): ?><span>没有了</span><?php else: ?><a href="<?php echo ($article['next']['url']); ?>"><?php echo ($article['next']['title']); ?></a><?php endif; ?></li>
                    </ul>
                </div>
            </div>
            <script>
    ...
    tuzkiNumber=1;
</script><div class="row b-comment"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 b-comment-box"> <img class="b-head-img" src="<?php if(empty($_SESSION['user']['head_img'])): ?>/blog/Template/default/Home/Public/image/default_head_img.gif<?php else: echo ($_SESSION['user']['head_img']); endif; ?>" alt="爵特猛博客" title="爵特猛博客"><div class="b-box-textarea"><div class="b-box-content" contenteditable="true" onfocus="delete_hint(this)">请先登录后发表评论</div><ul class="b-emote-submit"><li class="b-emote"><i class="fa fa-smile-o" onclick="getTuzki(this)"></i> <input class="form-control b-email" type="text" name="email" placeholder="接收回复的email地址" value="<?php echo ($user_email); ?>"><div class="b-tuzki"></div></li><li class="b-submit-button"> <input type="button" value="评 论" aid="<?php echo ($_GET['aid']); ?>" pid="0" onclick="comment(this)"></li><li class="b-clear-float"></li></ul></div><div class="b-clear-float"></div></div><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 b-comment-title"><ul class="row"><li class="col-xs-6 col-sm-6 col-md-6 col-lg-6">最新评论</li><li class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">总共<span><?php echo count($comment);?></span>条评论</li></ul></div><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 b-user-comment"><?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="row b-user b-parent"><div class="col-xs-2 col-sm-1 col-md-1 col-lg-1 b-pic-col"> <img class="b-user-pic js-head-img" src="/blog/Template/default/Home/Public/image/qq_default.jpg" _src="<?php echo ($v['head_img']); ?>" alt="爵特猛博客" title="爵特猛博客"></div><div class="col-xs-10 col-sm-11 col-md-11 col-lg-11 b-content-col b-cc-first"><p class="b-content"> <span class="b-user-name"><?php echo ($v['nickname']); ?></span>：<?php echo ($v['content']); ?></p><p class="b-date"> <?php echo date('Y-m-d H:i:s',$v['date']);?> <a href="javascript:;" aid="<?php echo ($_GET['aid']); ?>" pid="<?php echo ($v['cmtid']); ?>" username="<?php echo ($v['nickname']); ?>" onclick="reply(this)">回复</a></p><?php if(is_array($v['child'])): foreach($v['child'] as $key=>$n): ?><div class="row b-user b-child"><div class="col-xs-2 col-sm-1 col-md-1 col-lg-1 b-pic-col"> <img class="b-user-pic js-head-img" src="/blog/Template/default/Home/Public/image/qq_default.jpg" _src="<?php echo ($n['head_img']); ?>" alt="爵特猛博客" title="爵特猛博客"></div><ul class="col-xs-10 col-sm-11 col-md-11 col-lg-11 b-content-col"><li class="b-content"> <span class="b-reply-name"><?php echo ($n['nickname']); ?></span> <span class="b-reply">回复</span> <span class="b-user-name"><?php echo ($n['reply_name']); ?></span>：<?php echo ($n['content']); ?></li><li class="b-date"> <?php echo date('Y-m-d H:i:s',$n['date']);?> <a href="javascript:;" aid="<?php echo ($_GET['aid']); ?>" pid="<?php echo ($n['cmtid']); ?>" username="<?php echo ($n['reply_name']); ?>" onclick="reply(this)">回复</a></li><li class="b-clear-float"></li></ul></div><?php endforeach; endif; ?><div class="b-clear-float"></div></div></div><div class="row"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="b-border"></div></div></div><?php endforeach; endif; else: echo "" ;endif; ?></div></div>
        </div>
...
<ul>
    ...
    <li class="text-center"> 联系邮箱：<?php echo (C("ADMIN_EMAIL")); ?><!-- 站长统计开始 -->
...
<script type="text/javascript" src="/blog/Public/static/ueditor1_4_3/third-party/SyntaxHighlighter/shCore.js"></script>
<script type="text/javascript" src="/blog/Public/static/layer-2.4/layer.js"></script>
<script type="text/javascript">
    SyntaxHighlighter.all();
    ajaxCommentUrl="<?php echo U('Home/Index/ajax_comment','','',true);?>";
    check_login="<?php echo U('Home/User/check_login','','',true);?>";
</script>
<script type="text/javascript" src="/blog/Template/default/Home/Public/js/comment.js"></script>
</body>
</html>