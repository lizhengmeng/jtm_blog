...
<head>
<meta charset="UTF-8">
<title>开源项目-<?php echo (C("WEB_NAME")); ?></title>
...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav b-nav-parent">
            ...
            <li class="b-nav-cname <?php if(($cid) == "chat"): ?>b-nav-active<?php endif; ?> "> <a href="<?php echo U('Home/Index/chat');?>">随言碎语</a></li>
            <li class="b-nav-cname <?php if(($cid) == "bdai"): ?>b-nav-active<?php endif; ?> "> <a href="<?php echo U('Home/Index/bdai');?>">AI小应用</a></li>
            <li class="b-nav-cname hidden-sm <?php if(($cid) == "git"): ?>b-nav-active<?php endif; ?> "> <a href="<?php echo U('Home/Index/git');?>">开源项目</a></li>
        </ul>
...
<div id="b-content" class="container">
      <div class="row">
            ...
            .osc_git_main a{color: #4183c4;}
                  ...
                  <div class="github-widget" data-repo="baijunyao/thinkphp-bjyadmin">
                  </div>
                  <div class="github-widget" data-repo="baijunyao/thinkphp-bjyblog">
                  </div>
            </div>
...
<!-- 百度统计结束 -->
<script src="/blog/Public/static/js/jquery.githubRepoWidget.min.js"></script>
