    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-8 b-chat">
            <div class="b-chat-left">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><ul class="b-chat-one animated bounceInLeft">
                    ...
                    <div class="b-arrows-right1">
                        <div class="b-arrows-round">
                        </div>
                    </div>
                    <div class="b-arrows-right2">
                    </div>
                </ul><?php endif; endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="b-chat-middle">
            </div>
            <div class="b-chat-right">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($mod) == "1"): ?><ul class="b-chat-one animated bounceInRight">
                    <li class="b-chat-title "><?php echo (date('Y-m-d H:i:s',$v['date'])); ?></li>
                    <li class="b-chat-content"><?php echo ($v['content']); ?></li>
                    <div class="b-arrows-right1">
                        <div class="b-arrows-round">
